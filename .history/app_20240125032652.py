...
@app.route('/CDN/<page_name>')
def render_cdn(page_name):
    return render_template(f'/CDN/{page_name}')
...
def receive_ids():
    ...
    users = ideas_ref.get()
    arr1=users["0edf879d-ee94-4682-8164-0293f2cb3013"]["keywords"]
    arr2=users["290b6f04-663c-4155-b2f1-82ca9340022b"]["keywords"]
